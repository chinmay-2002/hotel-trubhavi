					...
					<li>
						<div class="w3layouts-banner-top">
							...
							<div class="container">
								...
								<h4>HOTEL TRUBHAVI</h4>
									<h3>We know what you desire</h3>
							...
							<!-- Modal content-->
								<div class="modal-content">
									<div class="modal-header">
										...
										<h4>HOTEL  <span>TRUBHAVI</span></h4>
										<img src="images/1.jpg" alt=" " class="img-responsive">
										<h5>We know what you desire</h5>
				...
				<ul class="cbp-ig-grid">
					<li>
						<div class="w3_grid_effect">
							...
							<span class="cbp-ig-category">HOTEL TRUBHAVI</span>
						</div>
					</li>
					<li>
						<div class="w3_grid_effect">
 	...
 	<div class="about-wthree" id="about">
		  <div class="container">
				   <div class="ab-w3l-spa">
                            <h3 class="title-w3-agileits title-black-wthree">About Our HOTEL TRUBHAVI</h3> 
...
<section class="contact-w3ls" id="contact">
	<div class="container">
		...
		<div class="col-lg-6 col-md-6 col-sm-6 contact-w3-agile1" data-aos="flip-right">
			...
			<p class="contact-agile1"><strong>Phone :</strong>+91 9325373355</p>
			<p class="contact-agile1"><strong>Email :</strong> <a href="mailto:name@example.com">info@trubhavi.com</a></p>
			<p class="contact-agile1"><strong>Address :</strong> Near J.T Mahajan College of engineering Faizpur, Jalgoan </p>
...
<!-- /contact -->
			<div class="copy">
		        <p>© 2023 HOTEL TRUBHAVI . All Rights Reserved | Design by <a href="index.php">RMC Dynamos</a> </p>
		    </div>
<!--/footer -->
<!-- js -->
